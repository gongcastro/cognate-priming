...
#'
get_attrition_participants <- function(
  attrition_trials,
  vocabulary,
  ...
  out <- attrition_trials |>
    ...
    mutate(
      is_valid_vocab_size = is_valid_vocab_size & !is.na(is_valid_vocab_size),
    ...
    rowwise() |>
    mutate(
      .ntrials = list(unlist(across(c(cognate, noncognate, unrelated))))
    ) |>
    ungroup() |>
