...
try         % and enable a possible "clean" exit
    ...
    imagesPath  = [mainDirectory '\Stimuli\Images\'];
    ...
    % %%%%%%%%
    DRAW_CUES = true;   %for DEBUG allow to dray AOI rectangle ans gazePoint
    %
    ...
    imagesPath    = [imagesPath 'images_' language '\'];
...
%     t7700 = (ceil(7.7 / monitorFlipInterval) - 0.5) * monitorFlipInterval; % 7700 ms
    ...
    primeImageDuration  = (ceil(1.5 / monitorFlipInterval) - 0.2) * monitorFlipInterval; % 1500 ms
    ...
    for iTrial = 1:nTrials % for each trial until nTtrials
        ...
        % for iGetter=1:n-1
            ...
            y        = y*screenYpixels;
            fullGazeData  = [fullGazeData; parseGazeData(gazeData, [participant,dateBirth,sex,dateTest,language,list,iTrial,num2str(num(ii,1)),words(ii,4),num2str(num(ii,6)),'getter',lookTextPrime,'center'])];
