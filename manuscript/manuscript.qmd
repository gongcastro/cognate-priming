...
Bilinguals infants start recognising words at similar ages. Using a Head-turn Preference Procedure and ERP registration,  @vihman2013 found English-Welsh bilinguals to be sensitive to the prevalence of auditorily presented words. Infants' looking times and ERP differed when presented with words frequently marked as "familiar" by caregivers of demographically equivalent peers (e.g., *nappy*, *thank you*, *bottle*, *apple*, and *naughty*), compared to when presented with rare words (e.g., *Eiffel*, *courtly*, *nettle*, *wacky*, and *juncture*). Bilinguals' trajectories of word recognition  [@vihman2013].
