...
vocab_plot_means <- vocab_plot_data |> 
	summarise(prop_sd = sd(prop, na.rm = TRUE),
			  ...
			  n = n(),
			  .by = c(age_group, type, side, lp, type, location)) |> 
...
vocab_plot_data |> 
	...
	geom_point(data = vocab_plot_means, 
			   ...
			   size = 1.25,
			   position = position_dodge(width = 1)) +
	# geom_label(data = vocab_plot_means,
	# 		   aes(label = sprintf("%.1f%%\n[%.1f, %.1f]",
	# 		   					prop*100, .lower*100, .upper*100),
	# 		   	y = 0),
	# 		   size = 2.5,
	# 		   fill = "white",
	# 		   vjust = 0,
...
.by = c(lp, trial_type, location)) |>
arrange(desc(lp)) |>
pivot_wider(id_cols = c(location, lp),
