...
stimuli |>
	...
	summarise(across(c(matches("n_phon|freq_|nphon|familiarity")),
	...
	# 			 fns = list(Total ~ mean(.)),
	# 			 fmt = ~ fmt_number(., decimals = 2)) |>
	grand_summary_rows(columns = matches("phon|freq"),
					   fns = list(Total ~ mean(.)),
					   fmt = ~ fmt_number(., decimals = 2)) |>
		grand_summary_rows(columns = matches("familiarity"),
					   fns = list(Total ~ mean(.)),
	...
	tab_style(list(cell_text(style = "italic")), 
