...
#| fig-width: 7
#| fig-height: 3
mp <- read_csv(file.path("manuscript", "_assets", "data", "mp-stimuli.csv"),
...
mp |> 
	...
	stat_summary(geom = "point",
				 ...
				 size = 1.5,
				 position = position_dodge(width = 1)) +
	geom_text_repel(data = summarise(mp, aoa = min(aoa, na.rm = TRUE),
