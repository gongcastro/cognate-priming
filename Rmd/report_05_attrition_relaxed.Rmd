...
```{r attrition_frequency_prime_relaxed, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, fig.height=4, out.width="100%"}
sample_size <- attrition_relaxed %>% 
...
attrition_relaxed %>% 
	...
	geom_label(data = sample_size, aes(y = 2, label = n),
...
```{r attrition_frequency_prime_causes_relaxed, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, fig.height=4, out.width="100%"}
# plot participants
attrition_relaxed %>% 
	left_join(distinct(stimuli, test_language, location, list, trial, trial_type, frequency_prime_childes)) %>% 
	drop_na(trial_type, frequency_prime_childes) %>% 
...
```{r attrition_frequency_target_causes_relaxed, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, fig.height=4, out.width="100%"}
attrition_relaxed %>% 
	left_join(distinct(stimuli, test_language, location, list, trial, trial_type, frequency_target_childes)) %>% 
	drop_na(trial_type, frequency_target_childes) %>% 
...
attrition_relaxed %>% 
	...
	geom_boxplot(fill = "white", width = 0.25,
				 position =  position_dodge(width = 0.5),
				 size = 1, outlier.colour = NA) +
	geom_label(data = sample_size, aes(y = 0.1, label = n),
			   position = position_dodge(width = 0.7), colour = "white") +
...
```{r attrition_familiarity_prime_causes_relaxed, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, fig.height=4, out.width="100%"}
# plot participants
attrition_relaxed %>% 
	left_join(distinct(stimuli, test_language, location, list, trial, trial_type, familiarity_prime)) %>% 
	drop_na(trial_type, familiarity_prime) %>% 
...
```{r attrition_familiarity_target_causes_relaxed, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, fig.height=4, out.width="100%"}
# plot participants
attrition_relaxed %>% 
	left_join(distinct(stimuli, test_language, location, list, trial, trial_type, familiarity_target)) %>% 
	drop_na(trial_type, familiarity_target) %>% 
