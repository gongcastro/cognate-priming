...
```{r define_model_relaxed, message=FALSE, warning=FALSE, include=FALSE, paged.print=FALSE}
...
```{r gaze_time_vocab_lower_relaxed, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE, paged.print=FALSE}
sample_size <- participants_relaxed %>% 
	count(age_group, lp)
...
```{r gaze_time_vocab_upper_relaxed, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE, paged.print=FALSE}
sample_size <- participants_relaxed %>% 
