...
```{r define_model_2125_mon_relaxed, message=FALSE, warning=FALSE, include=FALSE, paged.print=FALSE}
fit_2125_mon <- model_fits_relaxed$fit_2125_mon
```


```{r fixef_2125_mon_relaxed, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
...
```{r gaze_time_2125_mon_relaxed, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
...
augment(fit_2125_mon) %>% 
	...
	scale_y_continuous(limits = c(0.25, 0.75), labels = percent) + 
