...
## Preprocessing participant data
...
```{r gaze_time_location_25, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
...
```{r gaze_time_location_30, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
