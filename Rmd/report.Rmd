...
gaze %>% 
	...
	geom_violin(aes(trial_type, prop, colour = trial_type, fill = trial_type),
				position = position_dodge(width = 0.75)) +
	#stat_slab(position = position_nudge(x = 0.25)) +
	#geom_point(size = 2, shape = 1, stroke = 1, position = position_jitter(width = 0.1)) +
	geom_boxplot(aes(trial_type, prop, colour = trial_type, fill = trial_type,
					 group = interaction(age_group, trial_type)),
...
gtsave(data = main_effects, filename = "main_effects.png", path = here("Figures"))
main_effects
```
...
gtsave(data = main_effects, filename = "main_effects_21_mon.png", path = here("Figures"))
main_effects
