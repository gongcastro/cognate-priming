...
elog ~ age_group + trial_type * lp * (ot1 + ot2 + ot3) +
	...
	(1 + ot1 + ot2 + ot3 + trial_type + age_group + lp | target)
```
...
#### Random effects {.tabset .tab-pills}
...
```{r random_effects_target, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
