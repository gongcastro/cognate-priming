...
```{r participants_cdi_stringent_counter, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, fig.height=4, out.width="100%"}
# plot participants
participants_counter %>% 
	left_join(distinct(attrition_counter, participant, valid_participant)) %>%
...
```{r trials_attrition_location_stringent_counter, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, fig.height=8, out.width="100%"}
# plot participants
attrition_location <- attrition_counter %>% 
	left_join(select(participants_counter, participant, location)) %>% 
...
```{r attrition_counter, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, fig.height=12}

left_join(
	attrition_counter,
	select(
		participants_counter, age_group, location, lp, participant, date_test)
) %>% 
...
```{r participants_attrition_counter, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, fig.height=4, out.width="100%"}
# plot participants
attrition_counter %>% 
	left_join(select(participants_counter, participant, location)) %>% 
...
```{r trials_attrition_table_stringent_counter, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, fig.height=4, out.width="100%"}
# plot participants
attrition_counter %>% 
	left_join(select(participants_counter, participant, location)) %>% 
	drop_na(trial_type) %>% 
...
```{r trials_attrition_counter, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, fig.height=4, out.width="100%"}
# plot participants
attrition_counter %>% 
	left_join(select(participants_counter, participant, location)) %>% 
	count(location, lp, age_group, trial_type, valid_status) %>% 
...
```{r attrition_frequency_prime_stringent_counter, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, fig.height=4, out.width="100%"}
sample_size <- attrition_counter %>% 
...
```{r attrition_frequency_prime_causes_stringent_counter, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, fig.height=4, out.width="100%"}
# plot participants
attrition_counter %>% 
	left_join(distinct(stimuli, test_language, location, list, trial, trial_type, frequency_prime_childes)) %>% 
	drop_na(trial_type, frequency_prime_childes) %>% 
...
```{r attrition_frequency_target_stringent_counter, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, fig.height=4, out.width="100%"}
sample_size <- attrition_counter %>% 
...
```{r attrition_frequency_target_causes_stringent_counter, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, fig.height=4, out.width="100%"}
attrition_counter %>% 
	left_join(distinct(stimuli, test_language, location, list, trial, trial_type, frequency_target_childes)) %>% 
	drop_na(trial_type, frequency_target_childes) %>% 
...
```{r attrition_familiarity_prime_stringent_counter, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, fig.height=4, out.width="100%"}
sample_size <- attrition_counter %>% 
...
```{r attrition_familiarity_prime_causes_stringent_counter, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, fig.height=4, out.width="100%"}
# plot participants
attrition_counter %>% 
	left_join(distinct(stimuli, test_language, location, list, trial, trial_type, familiarity_prime)) %>% 
	drop_na(trial_type, familiarity_prime) %>% 
...
```{r attrition_familiarity_target_stringent_counter, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, fig.height=4, out.width="100%"}
sample_size <- attrition_counter %>% 
...
```{r attrition_familiarity_target_causes_stringent_counter, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, fig.height=4, out.width="100%"}
# plot participants
attrition_counter %>% 
	left_join(distinct(stimuli, test_language, location, list, trial, trial_type, familiarity_target)) %>% 
	drop_na(trial_type, familiarity_target) %>% 
...
```{r attrition_animacy_prime_stringent_counter, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
attrition_counter %>% 
...
```{r attrition_animacy_target_stringent_counter, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
attrition_counter %>% 
...
```{r attrition_category_prime_stringent_counter, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
attrition_counter %>% 
...
```{r attrition_category_target_stringent_counter, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
attrition_counter %>% 
