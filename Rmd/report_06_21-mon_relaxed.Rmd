...
```{r define_model_21_mon_relaxed, message=FALSE, warning=FALSE, include=FALSE, paged.print=FALSE}
fit_21_mon <- model_fits_relaxed$fit_21_mon
fit_21_mon_location <- model_fits_relaxed$fit_21_mon_location
fit_21_mon_frequency <- model_fits_relaxed$fit_21_mon_frequency
fit_21_mon_vocab_split<- model_fits_relaxed$fit_21_mon_vocab_split
fit_21_mon_vocab_balanced <- model_fits_relaxed$fit_21_mon_vocab_balanced
...
```{r fixef_21_mon_frequency_relaxed, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
...
```{r gaze_time_21_mon_frequency_relaxed, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
sample_size <- participants_relaxed %>% 
	filter(valid_participant, age_group=="21 months", lp=="Monolingual") %>% 
	count()
