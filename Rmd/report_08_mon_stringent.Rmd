...
```{r define_model_mon_stringent, message=FALSE, warning=FALSE, include=FALSE, paged.print=FALSE}
fit_mon <- model_fits$fit_mon
```


```{r fixef_mon_stringent, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
...
```{r gaze_time_mon_stringent, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
