...
We collected vocabulary data from participants. In Oxford, participants were sent the online version of the Oxford Communicative Development Inventory [OCDI, @hamilton2000infant] two weeks before each appointment. In Barcelona, participants were sent the online vocabulary inventory [BVQ](https://github.com/gongcastro/bvqdev) immediately after the appointment, and were given two weeks to fill it. In Oxford, families filled the vocabulary checklist in the testing language, and when the participant was monolingual, also in the second language. In Barcelona, all participants filled the Catalan and the Spanish versions of the vocabulary checklists. All checklists included the words involved in the trial lists. When filling the vocabulary checklist, families checked each word as being *understood*, *understood and produced* or *none*. Each response to either checklist was aggregated to produce several vocabulary measures:
...
attrition %>% 
	...
	cols_label(n_excluded = "Excluded",
			   n_valid = "Included",
			   freq_prime_mean_valid = "Included",
			   freq_prime_mean_excluded = "Excluded",
			   freq_target_mean_valid = "Included",
			   freq_target_mean_excluded = "Excluded",
			   familiarity_prime_mean_valid = "Included",
			   familiarity_prime_mean_excluded = "Excluded",
			   familiarity_target_mean_valid = "Included",
			   familiarity_target_mean_excluded = "Excluded") %>% 
	summary_rows(groups = TRUE,
...
str_repl <- c(
	...
	"b_lpmon_bil" = "Group",
	"b_trial_typerelated_unrelated" = "Prime (relatedness)",
	"b_trial_typecognate_noncognate" = "Prime (cognateness)",
	
	"b_age_group21_25:lpmon_bil" = "Age [21-25] × Group",
	"b_age_group25_30:lpmon_bil" = "Age [25-30] × Group",
	"b_age_group21_25:trial_typerelated_unrelated" = "Age [21-25] × Prime (relatedness)",
	"b_age_group21_25:trial_typecognate_noncognate" = "Age [21-25] × Prime (cognateness)",
	"b_age_group25_30:trial_typerelated_unrelated" = "Age [25-30] × Prime (relatedness)",
	"b_age_group25_30:trial_typecognate_noncognate" = "Age [25-30] × Prime (cognateness)",
	"b_lpmon_bil:trial_typerelated_unrelated" = "Group × Prime (relatedness)",
	"b_lpmon_bil:trial_typecognate_noncognate" = "Group × Prime (cognateness)",
	
	"b_age_group21_25:lpmon_bil:trial_typerelated_unrelated" = "Age [21-25] × Group × Prime (relatedness)",
	"b_age_group21_25:lpmon_bil:trial_typecognate_noncognate" = "Age [21-25] × Group × Prime (cognateness)",
	"b_age_group25_30:lpmon_bil:trial_typerelated_unrelated" = "Age [25-30] × Group × Prime (relatedness)",
	"b_age_group25_30:lpmon_bil:trial_typecognate_noncognate" = "Age [25-30] × Group × Prime (cognateness)"
)
