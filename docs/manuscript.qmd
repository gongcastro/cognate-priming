...
participants |>
    ...
    select(
        lp, study, test_language, starts_with("n_"), matches("TRUE"),
    ...
    cols_merge(c(n_participants, n_participants_FALSE),
        pattern = "{1} ({2})"
    ) |>
...
stimuli |>
    ...
    cols_merge(c(familiarity_prime_mean, familiarity_prime_sd),
        pattern = "{1} ({2})"
    ) |>
