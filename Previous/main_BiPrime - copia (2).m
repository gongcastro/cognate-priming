...
try         % and enable a possible "clean" exit
    ...
    variableNames={'SystemTimeStamp','meanX','meanY','meanValidity','lX','lY','lV','lPupil','lPupilV','rX','rY','rV','rPupil','rPupilV','sujeNUM','baby_id','date_birth','sex','testdate','language','list','numtrial_list','trial','trialtype','getternum','phase','stimulus','locationTARGET'};
